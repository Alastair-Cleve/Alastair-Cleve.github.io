var CodeSample = function (Element) {
  ...
  this.sample = ["using System;", "using System.Collections.Generic;", "using System.IO;",
    "using System.Text;", "0namespace BooleanLogicParser {", "1public class Tokenizer {",
    "2private readonly StringReader _reader;", "2private string _text;",
    "3public Tokenizer(string text) {", "4_text = text;", "4_reader = new StringReader(text);",
    "2}", "3public IEnumerable<Token> Tokenize() {", "4var tokens = new List<Token>();",
    "4while (_reader.Peek() != -1) {", "5while (Char.IsWhiteSpace((char)_reader.Peek())) {",
    "6_reader.Read();", "5}"];
  this.sampleIndex = 0;
